...
public class FormEmojis {
    public static int id; 

    public static void load() {
        //load the character id
        LoadedMod mod = Vars.mods.getMod("form");
        ...
        Texture pure = FormItems.lithium.uiIcon.texture;
        Texture genned =  FormBlocks.darkblueStone.uiIcon.texture;
        ...
        Seq.<UnlockableContent>withArrays(
                ...
                .add(new GenData(true, "sievers", Core.atlas.find("form-team-sievers")))
                .each(data -> {
         ...
         FormTeam.sievers.emoji = Reflect.<ObjectMap<String, String>>get(Fonts.class, "stringIcons").get(FormTeam.sievers.name, "");
    }
